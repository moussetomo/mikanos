...
namespace usb::xhci {
	...
	ExtendedRegisterList::ExtendedRegisterList(uint64_t mmio_base, HCCPARAMS1_Bitmap hccp) : first_{ AddOrNull(reinterpret_cast<ValueType*>(mmio_base), hccp.bits.xhci_extended_capabilities_pointer) } {}
}
